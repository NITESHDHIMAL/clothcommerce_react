...
import './App.css'
import { useGetProductIdQuery, useGetProductQuery } from './services/productApi'
...
function App() {
  ...
  // const responsInfo = useGetProductQuery()

  const { data, isError, isLoading } = useGetProductQuery()

  // const { data, } = useGetProductIdQuery(1)



  // console.log("all product", responsInfo)
  ...
  <div>
    ...
    image: <img src={data?.image} alt="product_image" />
